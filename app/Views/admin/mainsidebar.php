...
<div class="sidebar-wrapper" data-layout="fill-svg">
  <div>
    <div class="logo-wrapper"><a href=""><img class="img-fluid"
          src="<?php echo base_url(); ?>assets/admin/images/logo/logo.png" alt="" style="width: 30%;"></a>
      ...
      <div id="sidebar-menu">
        <ul class="sidebar-links uk-list" id="simple-bar">
          <li class="back-btn"><a href="index.html"><img class="img-fluid"
                src="<?php echo base_url(); ?>assets/admin/images/logo/logo-icon.png" alt=""></a>
          ...
          <?php if (in_array(28, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/dashboard"><span>Dashboard</span></a></li>
          <?php } ?>
          <?php if (in_array(27, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/subadmin"><span>Sub Admin</span></a></li>
          <?php } ?>
          <?php if (in_array(1, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/Purchase_Voucher"><span>Purchase</span></a></li>
          <?php } ?>
          ...
          <?php if (in_array(3, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/despatch_entry"><span>Despatch Entry</span></a></li>
          <?php } ?>
          ...
          <?php if (in_array(5, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/add_inhouse"><span>In House Maintance </span></a></li>
          <?php } ?>
          <?php if (in_array(6, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/outside_mentainance"><span>Out Side Maintance </span></a></li>
          <?php } ?>
          ...
          <?php if (in_array(37, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/task_Assignment"><span>Task Assignment </span></a></li>
          <?php } ?>
          ...
          <?php if (in_array(10, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/Overall_Expence"><span>Overall Expence </span></a></li>

          <?php } ?>
          <?php if (in_array(11, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/Driver_Salary"><span>Driver Salary </span></a></li>
          <?php } ?>
          <?php if (in_array(35, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/adjust_salary"><span>Adjust Salary </span></a></li>
          <?php } ?>
          <?php if (in_array(12, $jobAssign)) { ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/staff_Salary"><span>Staff Salary </span></a></li>
          <?php } ?>
          <?php if (in_array(40, $jobAssign)) { ?>
            <!-- <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav "
                href="<?php echo base_url(); ?>admin/payment_voucher"><span>Payment Voucher</span></a></li>
          <?php } ?> -->
          ...
          <li class="sidebar-list">
            ...
            <ul class="sidebar-submenu">
              ...
              <li><a href="<?php echo base_url(); ?>admin/CashBank">Cash/Book</a></li>
            </ul>
          </li>
          ...
          <?php if (in_array(29, $jobAssign)) { ?>
            <li class="sidebar-list">
              ...
              <ul class="sidebar-submenu">
                ...
                <li><a href="<?php echo base_url(); ?>admin/vehicle_types">Vehicle Type Master</a></li>
              </ul>
            </li>
          <?php } ?>
            ...
            <li class="sidebar-list">
              ...
              <ul class="sidebar-submenu">
                ...
                <?php if (in_array(38, $jobAssign)) { ?>
                  <li><a href="<?php echo base_url(); ?>admin/scrapTyer_management">Scrap Yard</a></li>
                  <li><a href="<?php echo base_url(); ?>admin/sentToVendorTyer_management">Exchange Requested</a></li>
                  <li><a href="<?php echo base_url(); ?>admin/soldTyer_management">Sold History</a></li>
                <?php } ?>
                ...
                <?php } ?>
                <li><a href="<?php echo base_url(); ?>admin/tyre_exchange_report">Exchange History</a></li>
              </ul>
            </li>
          <?php } ?>
          ...
          <?php if (in_array(34, $jobAssign)) { ?>
            <li class="sidebar-list">
              <a class="sidebar-link sidebar-title link-nav"
                href="<?php echo base_url(); ?>AditionalAdminPart/downloadDatabase">
