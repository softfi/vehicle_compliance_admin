                        ...
                        <?php if (!empty($tyer_list)) : ?>
                            <?php $sr_no = 1; foreach ($tyer_list as $tyer) : ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="<?= base_url(); ?>/admin/tyre_details_vw/<?= $tyer->id ?>" >View History</a></td>
                                    <?php if(in_array(38.1,$jobAssign)){ ?>
                                        <td><a class="btn btn-primary" href="<?= base_url(); ?>admin/trashTyreBackToStock/<?= $tyer->id ?>">Back to stock</a></td>
                                    <?php } ?>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
