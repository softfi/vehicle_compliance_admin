          ...
          <div class="container-fluid default-dashboard">
            ...
            <div class="uk-grid-small" uk-grid>
                ...
                <div class="uk-width-1-1 uk-margin-bottom-small">
                    ...
                    <input type="text" name="checked_by" class="uk-input" required>
                </div>
...
foreach ($regularcheckup as $record) {
    ...
    <tr>
        ...
        <td><input class="uk-checkbox" readonly  type="checkbox" <?php if($record->dgear_oil==1){echo "checked" ;}?>/> <?= $record->gear_oil ?><?= $record->uria ?></td>
        <td><input class="uk-checkbox" readonly  type="checkbox" <?php if($record->duria==1){echo "checked" ;}?>/> <?= $record->gear_oil ?><?= $record->remark ?></td>
