...
<style>
    ...
    /* Fix for header alignment in scrollable DataTables */
        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-sm-8 p-0 text-right">
                        <div class="dropdown d-inline-block">
                            <button class="btn btn-primary dropdown-toggle mt-3 mr-2" type="button"
                                id="sampleExportDropdown" data-bs-toggle="dropdown" aria-expanded="false"
                                style="width: 133px;">
                                Sample Export
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="sampleExportDropdown">
                                <li><a class="dropdown-item"
                                        href="<?= base_url('admin/export_staff_sample?type=DRIVER'); ?>">Driver
                                        Sample</a></li>
                                <li><a class="dropdown-item"
                                        href="<?= base_url('admin/export_staff_sample?type=STAFF'); ?>">Staff Sample</a>
                                </li>
                                <li><a class="dropdown-item"
                                        href="<?= base_url('admin/export_staff_sample?type=MECHANIC'); ?>">Mechanic
                                        Sample</a></li>
                            </ul>
                        </div>
                        <button class="btn btn-primary mr-2 mt-3" id="download_excel">Data Export</button>
                        ...
                        <?php if (in_array(15.2, $jobAssign)) { ?>
                            <button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#uploadexcel">Upload
                                Excel</button>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div id="offcanvas-flip" uk-offcanvas="flip: true; overlay: true">
                    <div class="uk-offcanvas-bar uk-padding-remove uk-width-1-2@m"
                        style="background:#fff; color:#212529;">
                        <button class="uk-offcanvas-close" type="button" uk-close></button>
                        <div class="uk-card uk-card-body uk-card-default">
                            <form action="<?= base_url(); ?>/admin/Add_staf" enctype="multipart/form-data"
                                method="post">
                                <div class="row">
                                    <!-- Basic Details -->
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control" name="user_type">
                                            <option value="DRIVER" <?= set_select('user_type', 'DRIVER'); ?>>Driver
                                            </option>
                                            <option value="STAFF" <?= set_select('user_type', 'STAFF'); ?>>Staff Master
                                            </option>
                                            <option value="MECHANIC" <?= set_select('user_type', 'MECHANIC'); ?>>Mechanic
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="name_bank"
                                            placeholder="Name in Bank" value="<?= set_value('name_bank'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>A/c No</label>
                                        <input type="number" class="form-control" name="ac_no" placeholder="Account No"
                                            value="<?= set_value('ac_no'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>IFSC Code</label>
                                        <input type="text" class="form-control" name="ifsc" placeholder="IFSC Code"
                                            value="<?= set_value('ifsc'); ?>">
                                    </div>
                                    <!-- DL -->
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="dl_number" placeholder="DL Number"
                                            value="<?= set_value('dl_number'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>DL Expiry</label>
                                        <input type="date" class="form-control" name="dl_expiry"
                                            value="<?= set_value('dl_expiry'); ?>">
                                    </div>
                                    <!-- Aadhaar -->
                                    <div class="col-sm-6">
                                        <label>Aadhaar Number</label>
                                        <input type="text" class="form-control" name="aadhaar_no"
                                            placeholder="Aadhaar No" value="<?= set_value('aadhaar_no'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="tel" class="form-control" name="tel" placeholder="Contact Number"
                                            value="<?= set_value('tel'); ?>">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="fathers_name"
                                            placeholder="Father's Name" value="<?= set_value('fathers_name'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Spouse Name</label>
                                        <input type="text" class="form-control" name="spouse_name"
                                            placeholder="Spouse Name" value="<?= set_value('spouse_name'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="tel" class="form-control" name="family_contact"
                                            placeholder="Family Contact" value="<?= set_value('family_contact'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Blood Group</label>
                                        <select class="form-control" name="blood_group">
                                            <?php foreach (['O+', 'O-', 'A+', 'A-', 'B+', 'B-', 'AB+', 'AB-'] as $bg): ?>
                                                <option value="<?= $bg ?>" <?= set_select('blood_group', $bg); ?>><?= $bg ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="address" class="form-control"
                                            placeholder="Enter Physical Address" value="<?= set_value('address'); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($staf->dl_front) && file_exists(FCPATH . 'uploads/' . $staf->dl_front)): ?>
                                            <img src="<?= base_url('uploads/' . $staf->dl_front) ?>" class="clickable-img"
                                                width="50" onclick="viewImage('<?= base_url('uploads/' . $staf->dl_front) ?>')">
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <?php if (!empty($staf->dl_back) && file_exists(FCPATH . 'uploads/' . $staf->dl_back)): ?>
                                            <img src="<?= base_url('uploads/' . $staf->dl_back) ?>" class="clickable-img"
                                                width="50" onclick="viewImage('<?= base_url('uploads/' . $staf->dl_back) ?>')">
                                        <?php endif; ?>
                                    </td>

                                    <td><?= $staf->dl_number ?></td>
                                    <td><?= !empty($staf->dl_expiry) ? date('d/m/Y', strtotime($staf->dl_expiry)) : '' ?>
                                    </td>
                                    ...
                                    <td>
                                        <?php if (!empty($staf->aadhaar_front) && file_exists(FCPATH . 'uploads/' . $staf->aadhaar_front)): ?>
                                            <img src="<?= base_url('uploads/' . $staf->aadhaar_front) ?>" class="clickable-img"
                                                width="50"
                                    ...
                                    <td>
                                        <?php if (!empty($staf->aadhaar_back) && file_exists(FCPATH . 'uploads/' . $staf->aadhaar_back)): ?>
                                            <img src="<?= base_url('uploads/' . $staf->aadhaar_back) ?>" class="clickable-img"
                                                width="50"
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <?php if (in_array(15.3, $jobAssign)) { ?>
                                                <a href="javascript:void(0);" onclick="editvehicle('<?= $staf->id; ?>');"
                                                    class="btn btn-sm btn-secondary">Edit</a>
                                            <?php } ?>
                                            <?php if (in_array(15.4, $jobAssign)) { ?>
                                                <a href="<?= base_url('Admin/DeleteStaff/' . $staf->id); ?>"
                                                    onclick="return confirm('Are you sure?');"
                                                    class="btn btn-sm btn-danger">Delete</a>
                                            <?php } ?>
                                            <a href="javascript:void(0);" onclick="printvehicle('<?= $staf->id; ?>');"
            ...
            <div class="modal fade" id="uploadexcel" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content p-3">
                        <p><a href="<?= base_url('sampleexcel/staffexcell.xlsx') ?>">Click here</a> to download sample
                        </p>
                        <form action="<?= base_url('Admin/upload_staff_excel') ?>" method="post"
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#myTable').DataTable({
            ...
            fixedHeader: false, // Sometimes conflicts with scrollX
            autoWidth: false,
            columnDefs: [
        ...
        // Ensure columns are aligned after initialization and on window resize
