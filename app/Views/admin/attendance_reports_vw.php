                ...
                <div class="card-body p-3">
                    ...
                    <form method="GET" action="" class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <label class="form-label small font-weight-bold text-uppercase">Month</label>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="kpi-content">
                                    ...
                                    <h4 class="kpi-value text-dark"><?= ($stats->leave_count ?? 0) + ($stats->half_day_count ?? 0) + ($stats->sick_leave_count ?? 0) + ($stats->holiday_count ?? 0); ?></h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        elseif ($record->status == 'Half-day') $badgeClass = 'info';
                                                         elseif ($record->status == 'Holiday') $badgeClass = 'warning';
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var options = {
            ...
            labels: ['Present', 'Absent', 'Leave', 'Half-day', 'Sick-leave', 'Holiday'],

            colors: ['#51bb25', '#dc3545', '#ffc107', '#17a2b8', '#000000', '#ff9f43'],
